...
void tripletSum(int arr[], int length){
    ...
    //         cout << "Sum of " << arr[i] << ", " << arr[(i+1)] << " and " << arr[(i+2)] << " is : " << sum << endl;
    //     }
    //     cout << "The elements " << arr[length-2] << " and " << arr[length-1] << " does not form a triplet." << endl;
    // }
    //  else if(length % 3 == 1){
    ...
    //         cout << "Sum of " << arr[i] << ", " << arr[(i+1)] << " and " << arr[(i+2)] << " is : " << sum << endl;
    //     }
    //     cout << "The element " << arr[length-1] << " does not form a triplet." << endl;
    // }
     else if(length % 3 != 0){
        for(int i=0; i<length-2; i+=3){
            sum = arr[i] + arr[(i+1)] + arr[(i+2)];
...
int main(){
    ...
    int arr[10] = {1, 3, 5, 7, 9, 10, 11, 14, 25, 28};
